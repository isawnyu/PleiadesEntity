...
VIEW_MAP = {
    ...
    'application/json': u'@@newjson',
    'application/javascript': u'@@newjson',
    'application/x-javascript': u'@@newjson',
    'text/javascript': u'@@newjson',
    'aplication/ld+json': u'@@newjson',
    'application/vnd.geo+json': u'@@newjson',
