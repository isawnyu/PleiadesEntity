...
#    ),
    ...
    ReferenceField(
        ...
        widget=ReferenceBrowserWidget(
            label="Connected to",
            description="Assertion that this place is connected to another place.",
            startup_directory="/places",
            allow_browse=0,
            allow_search=1,
    ...
    BackReferenceField(
        ...
        widget=BackReferenceWidget(
            visible="{'view': 'visible', 'edit': 'invisible'}",
            label="Has a connection from",
            description="It is asserted that another place is connected to this place."
            macro="betterbackrefwidget",
