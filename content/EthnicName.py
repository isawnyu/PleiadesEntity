...
EthnicName_schema = BaseFolderSchema.copy() + \
...
class EthnicName(Name, BaseFolder):
    """
    """
    ...
    archetype_name = 'Ancient Ethnic Name'

    meta_type = 'EthnicName'
    portal_type = 'EthnicName'
    allowed_content_types = [] + list(getattr(Name, 'allowed_content_types', []))
    filter_content_types = 1
    global_allow = 0
    #content_icon = 'EthnicName.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "Any name used in antiquity to identify a people, tribe or citizen/resident of a place"
    typeDescMsgId = 'description_edit_ethnicname'

    _at_rename_after_creation = True

    schema = EthnicName_schema
